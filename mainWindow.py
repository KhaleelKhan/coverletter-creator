...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabAboutMe)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.label_17 = QtWidgets.QLabel(self.tabAboutMe)
        self.label_17.setObjectName("label_17")
        self.verticalLayout_3.addWidget(self.label_17, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        self.te_aboutMe = QtWidgets.QPlainTextEdit(self.tabAboutMe)
        self.te_aboutMe.setObjectName("te_aboutMe")
        self.verticalLayout_3.addWidget(self.te_aboutMe)
        self.mainTabWidget.addTab(self.tabAboutMe, "")
        self.tabWhyFirm = QtWidgets.QWidget()
        self.tabWhyFirm.setObjectName("tabWhyFirm")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.tabWhyFirm)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_18 = QtWidgets.QLabel(self.tabWhyFirm)
        self.label_18.setObjectName("label_18")
        self.verticalLayout_4.addWidget(self.label_18, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        self.te_WhyFirm = QtWidgets.QPlainTextEdit(self.tabWhyFirm)
        self.te_WhyFirm.setObjectName("te_WhyFirm")
        self.verticalLayout_4.addWidget(self.te_WhyFirm)
        self.mainTabWidget.addTab(self.tabWhyFirm, "")
        self.tabWhyYou = QtWidgets.QWidget()
        self.tabWhyYou.setObjectName("tabWhyYou")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.tabWhyYou)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.label_19 = QtWidgets.QLabel(self.tabWhyYou)
        self.label_19.setObjectName("label_19")
        self.verticalLayout_5.addWidget(self.label_19, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        self.te_whyYou = QtWidgets.QPlainTextEdit(self.tabWhyYou)
        self.te_whyYou.setObjectName("te_whyYou")
        self.verticalLayout_5.addWidget(self.te_whyYou)
