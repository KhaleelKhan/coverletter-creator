...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout = QtWidgets.QFormLayout(self.tabPersonal)
		...
		self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.te_personalAddress)
